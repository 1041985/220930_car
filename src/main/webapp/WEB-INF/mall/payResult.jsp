...
<section class="cart">
		...
		<tbody>
			...
			<tr>
				...
				<%-- 	<c:forEach var="item" items="${carList}"> --%>
						...
						<img id="img_car" src="<%=request.getContextPath()%>/resources/images/${images[0]}">
						<br/>
				</td>
				<td><a class="com-link" href="orderDetail.mall?cnum=${item.cnum}">주문 상세보기</a></td>
			</tr>
					</c:forEach>
		</tbody>
	</table>
	...
	<div class="cart__mainbtns" align="center">
		<button class="cart__bigorderbtn right" onClick="goShop()">쇼핑 계속하기</button>
	</div>
